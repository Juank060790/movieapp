...
function App() {
  ...
  if (movieList === null) {
    return <h2>Loading... <img src="./favicon.gif" alt="loading" width="1700px"></img> </h2>
  }
  ...
  return (
    ...
    <div>
      ...
      <Navbar originalList={originalList} setMovieList={setMovieList} handleSelect={handleSelect}
        searchByTopRated={searchByTopRated} genreList={genreList}/>
      <CoverSection />
